...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatMatches: function (matches) { return matches + " 条数据有效."; },
        formatNoMatches: function () { return "没有匹配数据"; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "请再输入 " + n + " 个以上字符" + (n == 1? "" : ""); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "请删除 " + n + " 个字符" + (n == 1? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "只能选择 " + limit + " 个选项" + (limit == 1 ? "" : "s"); },
