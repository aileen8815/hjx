...
<header class="panel-heading">
    <a href="${base}/customer/contact">客户联系人</a> - 
    <#if contact.id?exists>编辑<#else>新建</#if>
</header>
<div class="panel-body main-content-wrapper site-min-height">
  <form id="customer-form" action="${base}/customer/contact/${contact.id!}" method="post" class="form-horizontal" data-parsley-validate>
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <input type="text" class="form-control" name="email" id="email" value="${contact.email!}" data-parsley-required="true" data-parsley-type="email">
      </div>
    </div>
      <div class="form-group">
