...
<div class="panel-body main-content-wrapper site-min-height">
  ...
  <table class="easyui-datagrid" toolbar="#outbound-booking-toolbar" id="outbound-booking-datagrid" 
      data-options="url:'${base}/customer/customer-outbound-booking/list',method:'get',rownumbers:true,singleSelect:true,pagination:true,fitColumns:true,collapsible:false">
    <thead>
     <tr>
  ...
  <div class="col-md-12" id="outbound-booking-toolbar">
    <div class="row row-toolbar">
      <div class="col-md-4">
        <div class="m-b-sm">
          <div class="btn-group">
            <a href="${base}/customer/customer-outbound-booking/new" class="btn btn-primary"><i class="fa fa-plus-square"></i> 新建</a>
...
<script type="text/javascript">
  var storelocationtypejs = {
    ...
    edit: function(){
      ...
      if (row){
        location.href = "${base}/customer/customer-outbound-booking/" + row.id + "/edit";
      } else {
        alert('请选择要编辑的数据！');
      }
    },
    ...
    remove: function(){
      ...
      if (row){
        if(confirm('确实要删除选中数据吗？')){
          location.href = "${base}/customer/customer-outbound-booking/" + row.id + "/delete";
        }
      }else{
        alert('请选择要删除的数据！');
      }
    ...
    var url="${base}/customer/customer-outbound-booking/"+row.id;
