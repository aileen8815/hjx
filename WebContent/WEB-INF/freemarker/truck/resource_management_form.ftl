<#escape x as x?html>
<header class="panel-heading"> <a href="${base}/truck/resource-management">资源管理</a> - 
  <#if vehicleType.id?exists>编辑<#else>新建</#if> 
</header>
<div class="panel-body main-content-wrapper site-min-height">
  <form id="person-form" action="${base}/truck/resource-management/${resourceManagement.id!}" method="post" class="form-horizontal" data-parsley-validate>
