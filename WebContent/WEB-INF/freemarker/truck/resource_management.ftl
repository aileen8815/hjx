...
<header class="panel-heading">
    <a href="${base}/truck/resource-management">资源管理</a>
</header>
<div class="panel-body main-content-wrapper site-min-height">
  ...
  <table class="easyui-datagrid" toolbar="#resourcemanagement-toolbar" id="resourcemanagement-datagrid" 
      data-options="url:'${base}/truck/resource-management/list',method:'get',rownumbers:true,singleSelect:true,pagination:true,fitColumns:true,collapsible:false">
    <thead>
      <tr>
  ...
  <div class="col-md-12" id="resourcemanagement-toolbar">
    <div class="row row-toolbar">
      <div class="col-md-4">
        <div class="m-b-sm">
          <div class="btn-group">
            <a href="${base}/truck/resource-management/new" class="btn btn-primary"><i class="fa fa-plus-square"></i> 新建</a>
...
<script type="text/javascript">
  var tooljs = {
    edit: function(){
      ...
      if (row){
        location.href = "${base}/truck/resource-management/" + row.id + "/edit";
      } else {
        alert('请选择要编辑的数据！');
      }
    },
    ...
    remove: function(){
      ...
      if (row){
        if(confirm('确实要删除选中数据吗？')){
          location.href = "${base}/truck/resource-management/" + row.id + "/delete";
        }
      }else{
        alert('请选择要删除的数据！');
      }
