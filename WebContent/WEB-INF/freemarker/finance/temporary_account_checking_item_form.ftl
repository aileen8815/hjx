...
<div class="panel-body main-content-wrapper site-min-height">
  <form id="paymentItem-form" action="${base}/finance/payment/${id}/save-account-checking-item?accountCheckingId=${accountCheckingId}" method="post" class="form-horizontal" data-parsley-validate>
    ...
    <div class="form-group">
      ...
      <div class="col-md-3">
       	<input type="text" class="form-control" name="amount" id="amount"  value="${paymentItem.amount!}" data-parsley-required="true" data-parsley-type="number"  data-parsley-min="0">
      </div>
      <label class="col-md-2 control-label">实收金额：</label>
      <div class="col-md-3">
        <input type="text" class="form-control" name="actuallyAmount" id="actuallyAmount"   value="${paymentItem.actuallyAmount!}" data-parsley-required="true" data-parsley-type="number"  data-parsley-min="0">
      </div>
    </div>
    <!--
    <div class="form-group">
