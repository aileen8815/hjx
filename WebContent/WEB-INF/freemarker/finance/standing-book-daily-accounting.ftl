...
<header class="panel-heading">
    <a href="${base}/finance/standing-book-daily/accounting">冷库结算收费台账</a>
</header>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <select id="customerid" name="customerid" class="form-control" data-parsley-required="true">
...
<script>
    ...
    function loadReport() {
        ...
        var dataUrl = "${base}/finance/standing-book-daily/search-accounting?customerId="
