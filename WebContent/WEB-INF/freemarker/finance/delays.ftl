  ...
  <table class="easyui-datagrid" toolbar="#payment-toolbar" id="payment-datagrid" 
    ...
    <thead>
      <tr>
		...
		<th data-options="field:'settleRange',width:140,fixed:true">结算周期</th>
        ...
        <div style="text-align:right">
          <form class="form-inline" id="store-contract-form">
            <div class="form-group">
                ...
                <select class="form-control" id="customerId" name="customerId" style="width:80px;text-align:left;margin-right:6px;">
                    <option value="">客户</option>
                    <#list customers as c>
                    <option value="${c.id!}">${c.name!}</opton> 
                    </#list>
                </select>
            </div>          
