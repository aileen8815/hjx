<#escape x as x?html>
<header class="panel-heading"> <a href="${base}/report/report-payment">收款明细报表</a> </header>
<div class="panel-body main-content-wrapper site-min-height">
  <div>
    <form id="payment-report" target="reportFrame" action="${reportUrl}/pentaho/api/repos/%3Apublic%3Apayment.prpt/report"
      ...
      <div class="col-md-12">
      <div class="form-group">
        <label class="col-md-2 control-label">收费项目:</label>
        <div class="col-md-2">
          <select id="cefeeitemid" name="cefeeitemid" class="form-control" >
            <option value="0">收费项目</option>
            <#list cefeeitemlist as cefeeitem>
            <option value="${cefeeitem.id}">${cefeeitem.name!}</option>
            </#list>
          </select>
        </div>
