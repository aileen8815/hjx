...
<header class="panel-heading">
  <a href="${base}/report/report-charge-collect">营业收入汇总报表</a>
</header>
<div class="panel-body main-content-wrapper site-min-height">
  <div>
    <form id="payment-report" target="reportFrame" action="${reportUrl}/pentaho/api/repos/%3Apublic%3AChargeCollect.prpt/report"
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
              <label style="width:100px;" class="col-md-1 control-label">开始日期:</label>
              <div class="col-md-2">
                <input type="text" class="form-control Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name="startTime" id="startTime" value="${.now?string('yyyy-MM-dd')}" placeholder="开始日期" >
              </div>
              <label  style="width:100px;" class="col-md-1 control-label">截止日期:</label>
              <div class="col-md-2">
